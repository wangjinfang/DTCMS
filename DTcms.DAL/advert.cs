...
namespace DTcms.DAL
{
    ...
    public partial class advert
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from " + databaseprefix + "adverts");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 title from " + databaseprefix + "adverts");
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into " + databaseprefix + "adverts(");
            strSql.Append("title,type,price,remark,view_num,view_width,view_height,target,add_time,belongchannel)");
            ...
            parameters[9].Value = model.belongchannel;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "adverts set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,title,type,price,remark,view_num,view_width,view_height,target,add_time,belongchannel from " + databaseprefix + "adverts ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,title,type,price,remark,view_num,view_width,view_height,target,add_time,belongchannel ");
            strSql.Append(" FROM " + databaseprefix + "adverts ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,type,price,remark,view_num,view_width,view_height,target,add_time,belongchannel ");
            strSql.Append(" FROM " + databaseprefix + "adverts ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM " + databaseprefix + "adverts");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
