...
namespace DTcms.DAL
{
		...
		public partial class browse_goods
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from td_browse_goods");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into td_browse_goods(");			
            strSql.Append("user_id,goods_id,img_url,goods_name,add_time,time");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update td_browse_goods set " + strValue);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update td_browse_goods set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from td_browse_goods ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Model.browse_goods GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, user_id, goods_id, img_url, goods_name, add_time, time  ");			
			strSql.Append("  from td_browse_goods ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.browse_goods model=new Model.browse_goods();
		...
		{
			StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM td_browse_goods ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
		...
		{
			StringBuilder strSql = new StringBuilder();
            strSql.Append("select "+strSelect+" FROM td_browse_goods ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
