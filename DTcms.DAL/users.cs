...
namespace DTcms.DAL
{
    ...
    public partial class users
    {
        ...
        public int Add(Model.users model)
        {
            ...
            strSql.Append("group_id,user_name,password,salt,email,nick_name,avatar,sex,birthday,telphone,mobile,qq,address,safe_question,safe_answer,amount,point,exp,status,reg_time,reg_ip,user_type,user_status,province,city,district,purchase,purchase_mobile,parent_id,branch_id,real_name)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@purchase",SqlDbType.NVarChar,50),
                    new SqlParameter("@purchase_mobile",SqlDbType.NVarChar,50),
            ...
            parameters[21].Value = model.user_type;
            parameters[22].Value = model.user_status;
            ...
            parameters[27].Value = model.purchase_mobile;
            parameters[28].Value = model.parent_id;
            parameters[29].Value = model.branch_id;
            parameters[30].Value = model.real_name;
        ...
        public bool Update(Model.users model)
        {
            ...
            strSql.Append("purchase_mobile=@purchase_mobile, ");
            ...
            parameters[22].Value = model.user_type;
            parameters[23].Value = model.user_status;
            parameters[24].Value = model.province;
            parameters[25].Value = model.city;
            parameters[26].Value = model.district;
            parameters[27].Value = model.purchase;
            parameters[28].Value = model.purchase_mobile;
            parameters[29].Value = model.parent_id;
            parameters[30].Value = model.branch_id;
            parameters[31].Value = model.real_name;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,group_id,user_name,password,salt,email,nick_name,avatar,sex,birthday,telphone,mobile,qq,address,safe_question,safe_answer,amount,point,exp,status,reg_time,reg_ip,user_type,user_status,province,city,district,purchase,purchase_mobile,parent_id,branch_id,real_name ");
        ...
        public DataSet GetBranchList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" * ");
            strSql.Append(" FROM view_user_branch ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM view_user_branch");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
