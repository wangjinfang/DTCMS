...
namespace DTcms.DAL
{
    ...
    public partial class branch
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from td_branch");
            strSql.Append(" where ");
            strSql.Append(" id = @id  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update td_branch set " + strValue);
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from td_branch ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM td_branch ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int pageSize, int pageIndex, string strSelect, string strWhere, string filedOrder, out int recordCount)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("select " + strSelect + " FROM td_branch ");
                if (strWhere.Trim() != "")
                {
                    strSql.Append(" where " + strWhere);
                }
        ...
        public DataSet GetBranchList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" * ");
            strSql.Append(" FROM view_branch_count ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM view_branch_count");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
