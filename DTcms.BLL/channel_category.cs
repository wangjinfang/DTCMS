	...
	public partial class channel_category
	{
		...
		public bool Update(Model.channel_category model)
		{
            ...
            if (dal.Update(model))
            {
                ...
                {
                    //更改频道分类对应的目录名称
                    Utils.MoveDirectory(siteConfig.webpath + DTKeys.DIRECTORY_REWRITE_ASPX + "/" + oldModel.build_path,
                        siteConfig.webpath + DTKeys.DIRECTORY_REWRITE_ASPX + "/" + model.build_path);
                    Utils.MoveDirectory(siteConfig.webpath + DTKeys.DIRECTORY_REWRITE_HTML + "/" + oldModel.build_path,
        ...
        {
            List<Model.channel_category> modelList = new List<DTcms.Model.channel_category>();
            ...
            if (rowsCount > 0)
            {
                ...
                {
                    model = new DTcms.Model.channel_category();
