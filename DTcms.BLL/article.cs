...
namespace DTcms.BLL
{
    ...
    public partial class article
    {
        ...
        {
            return dal.GetAlbumsList(top,strwhere,strorder);
        }
        ...
        {
            return dal.GetAttributeList(top, strwhere, strorder);
        }
        ...
        {
            return dal.GetGroupPrice(article_id, group_id);
        }
        ...
        {
            return dal.get_order_buy_good(top, category_id);
        }
    }
}