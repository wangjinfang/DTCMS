...
namespace DTcms.BLL
{
    ...
    {
        private readonly DAL.prizes dal = new DAL.prizes();
        public prizes()
        { }
        #region  Method
        /// <summary>
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.prizes model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.prizes model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.prizes GetModel(int id)
        {
