<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.UI.Page.qyservicedetails" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <!--顶部 end-->\r\n    <!--企业服务详情页 开始-->\r\n    <div class=\"qydetails\">\r\n        <!--企业服务详情页左侧 开始-->\r\n        <div class=\"qydetailsl\">\r\n            <div class=\"qyname\">\r\n                <i></i>");
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("\r\n            </div>\r\n            <div class=\"qypic\">\r\n                <img src=\"");
	templateBuilder.Append(model.fields["log_img"].ToString());

	templateBuilder.Append("\" width=\"250px\" height=\"100px\" alt=\"");
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("\">\r\n            </div>\r\n            <div class=\"qytxt\">\r\n                <p>\r\n                    ");
	templateBuilder.Append(model.fields["intro"].ToString());

	templateBuilder.Append("\r\n                </p>\r\n            </div>\r\n            <div class=\"qycontact\">\r\n                <h2>\r\n                    联系方式</h2>\r\n                <p>\r\n                    网址：");
	templateBuilder.Append(model.fields["link"].ToString());

	templateBuilder.Append("</p>\r\n                <p>\r\n                    电话：");
	templateBuilder.Append(model.fields["phone"].ToString());

	templateBuilder.Append("</p>\r\n                <p>\r\n                    地址：");
	templateBuilder.Append(model.fields["address"].ToString());

	templateBuilder.Append("</p>\r\n            </div>\r\n            <div class=\"qybtn\">\r\n                <div class=\"qybtntop\">\r\n                    <input type=\"button\" value=\"浏览企业官网\" class=\"qybigbtn\" onclick=\"javascript:location='");
	templateBuilder.Append(model.fields["link"].ToString());

	templateBuilder.Append("';\">\r\n                </div>\r\n                <div class=\"qybtnbot\">\r\n                    <input type=\"button\" value=\"上一个\" class=\"qysmallbtn\" ");
	if (preid>0)
	{

	templateBuilder.Append("onclick=\"javascript:location='");
	templateBuilder.Append(linkurl("qyservicedetails",preid));

	templateBuilder.Append("';\"\r\n                        ");
	}	//end for if

	templateBuilder.Append(">\r\n                    <input type=\"button\" value=\"返回列表\" class=\"qysmallbtn mar12\" onclick=\"javascript:location='");
	templateBuilder.Append(linkurl("qyservice"));

	templateBuilder.Append("';\">\r\n                    <input type=\"button\" value=\"下一个\" class=\"qysmallbtn\" ");
	if (nextid>0)
	{

	templateBuilder.Append("onclick=\"javascript:location='");
	templateBuilder.Append(linkurl("qyservicedetails",nextid));

	templateBuilder.Append("';\"\r\n                        ");
	}	//end for if

	templateBuilder.Append(">\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"qydetailsr\">\r\n            ");
	...
	templateBuilder.Append("\r\n    <!--底部 end-->\r\n    <!--左侧箭头收缩效果 开始-->\r\n    <script type=\"text/javascript\">\r\n        $(\".qyname i\").click(function () {\r\n            $(\".qypic\").slideToggle(\"normal\");\r\n            if ($(this).hasClass(\"detarrow\")) {\r\n                //如果存在就这里\r\n                $(this).removeClass(\"detarrow\");\r\n            } else {\r\n                //这里的代码\r\n                $(this).addClass(\"detarrow\");\r\n            }\r\n        });\r\n    </");
	templateBuilder.Append("script>\r\n    <!--左侧箭头收缩效果 结束-->\r\n</body>\r\n</html>\r\n");
