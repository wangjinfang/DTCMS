...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <!--/Header-->\r\n    <!--Tab start-->\r\n    <div class=\"Tab\">\r\n        <div class=\"Tab_title\">\r\n            <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/tag_left.jpg\" class=\"img_left\" width=\"3\" height=\"32\" />\r\n            <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/tag_right.jpg\" class=\"img_right\" width=\"3\" height=\"32\" />\r\n            ");
	if (parent_category_id<=0)
	{

	templateBuilder.Append("\r\n            \r\n            <a href=\"javascript:;\" id=\"parent_category_title\" onclick=\"get_good_list(1,12,'0','','',$('#top_txt_sel').val(),'other')\">");
	templateBuilder.Append(Utils.ObjectToStr(parent_category_title));
	templateBuilder.Append("</a>\r\n            ");
	}
	else
	{

	templateBuilder.Append("\r\n            <a href=\"javascript:;\" id=\"parent_category_title\" onclick=\"$('#good_category_id').val('");
	templateBuilder.Append(Utils.ObjectToStr(parent_category_id));
	templateBuilder.Append("');get_good_list(1,12,'");
	templateBuilder.Append(Utils.ObjectToStr(parent_category_id));
	templateBuilder.Append("','','',$('#top_txt_sel').val(),'default')\">");
	templateBuilder.Append(Utils.ObjectToStr(parent_category_title));
	templateBuilder.Append("</a>\r\n            ");
	}	//end for if

	templateBuilder.Append("\r\n            </div>\r\n        <div class=\"slider_pic\" id=\"slider_pic\" style=\" position:relative;\">\r\n            <div id=\"prev\" class=\"Previous_Next\" style=\"background: url('");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/Previous.jpg') no-repeat center center;\r\n                position: absolute; left: 0px; top: 0px; z-index: 999;\">\r\n            </div>\r\n           \r\n            <ul style=\"margin-left: 35px; width:99999px;position:absolute;\" id=\"ul_category\">\r\n               \r\n                ");
	DataTable category_list_tit = get_category_child_list("goods", parent_category_id);
	...
	templateBuilder.Append("\r\n                <li style=\" width:112px;\"><a href=\"javascript:;\" onclick=\"$('#good_category_id').val('" + Utils.ObjectToStr(cdr2_tit["id"]) + "');$(this).css('background','#FF572B');$(this).parent().siblings().find('a').css('background','#F2F2F2');get_good_list(1,12,'" + Utils.ObjectToStr(cdr2_tit["id"]) + "','','',$('#top_txt_sel').val(),'default')\">" + Utils.ObjectToStr(cdr2_tit["title"]) + "</a></li>  \r\n                ");
	}	//end for if

	templateBuilder.Append("\r\n            </ul>\r\n            \r\n            <div id=\"next\" class=\"Previous_Next\" style=\"background: url('");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/next.jpg') no-repeat center center;\r\n                position: absolute; right: 0px; top: 0px;\">\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <!--Tab end-->\r\n    <!--Tab2 start-->\r\n    <div class=\"Tab2\">\r\n        <div class=\"To_shoppingcar\">\r\n            <a href=\"javascript:;\" onclick=\"batch_to_shopping()\">\r\n                <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/tag2_left.jpg\" class=\"img_left\" />\r\n                <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/tag2_right.jpg\" class=\"img_right\" />批量进入购物车</a></div>\r\n        <div class=\"contrast\" style=\" display:none;\">\r\n            <a href=\"#\">\r\n                <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/tag2_left.jpg\" class=\"img_left\" />\r\n                <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/tag2_right.jpg\" class=\"img_right\" />对比</a>\r\n            <span>2</span>\r\n        </div>\r\n        <div class=\"sort\">\r\n            <div class=\"sort_left\">\r\n                <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/tag2_left.jpg\" class=\"img_left\" />排序：</div>\r\n            <div class=\"sort_center\">\r\n                <select onchange=\"goods_sel_change()\"  id=\"sel_order\">\r\n                    <option value=\"default\" ");
	if (strorder=="default" || strorder=="")
	{

	templateBuilder.Append(" selected=\"selected\"\r\n                        ");
	}	//end for if

	templateBuilder.Append(">默认排序</option>\r\n                    <option value=\"moneya\" ");
	if (strorder=="moneya")
	{
	...
	templateBuilder.Append(">价格最低</option>\r\n                    <option value=\"moneyd\" ");
	if (strorder=="moneyd")
	{
