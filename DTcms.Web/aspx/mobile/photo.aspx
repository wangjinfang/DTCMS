...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable redphoto = get_article_list("photo", 0, 3, "status=0 and is_red=1");
	...
	templateBuilder.Append("\r\n        </ul>\r\n      </div>\r\n      <!--/推荐图片-->\r\n      \r\n      <!--最新图片-->\r\n      <div class=\"section\">\r\n        <h1>最新图片</h1>\r\n      </div>\r\n      <div>\r\n        <ul class=\"photo-list\">\r\n          ");
	DataTable newPhoto = get_article_list("photo", 0, 9, "status=0");
	...
	DataTable hotPhoto = get_article_list("photo", 0, 10, "status=0", "click desc");
	...
	DataTable category_list2 = get_category_child_list("photo", Utils.StrToInt(Utils.ObjectToStr(cdr1["id"]), 0));
