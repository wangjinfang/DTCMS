<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.UI.Page.meal_show" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(Utils.ObjectToStr(model_meal.title));
	templateBuilder.Append(" - 企力办公</title>\r\n    <link rel=\"stylesheet\" type=\"text/css\" href=\"");
	...
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/qlpic_030.jpg\");\r\n            background-position: 0 -113px;\r\n            line-height: 20px;\r\n            font-weight: bold;\r\n        }\r\n        .next\r\n        {\r\n            position: absolute;\r\n            width: 34px;\r\n            height: 112px;\r\n            cursor: pointer;\r\n            top: 0;\r\n            background-image: url(\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/qlpic_090.jpg\");\r\n            background-position: 0 -113px;\r\n            line-height: 20px;\r\n            font-weight: bold;\r\n        }\r\n        .next\r\n        {\r\n            right: 20px;\r\n        }\r\n        .no_click_1\r\n        {\r\n            background-image: url(");
	templateBuilder.Append("/templates/ql");
	...
	templateBuilder.Append("script>\r\n</head>\r\n<body>\r\n    ");
	DTcms.Model.users _userinfo = GetUserInfo();
	...
	DataTable dtss = meal_bll.GetList("").Tables[0];

	int hotdr2__loop__id=0;
	foreach(DataRow hotdr2 in dtss.Rows)
	{
		hotdr2__loop__id++;


	templateBuilder.Append("\r\n                <li class=\"lp1\"><a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr2["id"])));

	templateBuilder.Append("\"><b>\r\n                    <img src=\"" + Utils.ObjectToStr(hotdr2["img_url"]) + "\" width=\"80\" height=\"80\" ");
	if (id==int.Parse(Utils.ObjectToStr(hotdr2["id"]).ToString()))
	{

	templateBuilder.Append("class=\"kong\"\r\n                        ");
	}
	else
	{

	templateBuilder.Append("class=\"filt\" ");
	}	//end for if

	templateBuilder.Append(" /></b>\r\n                    <p style=\"text-align: center; height: 21px;\">\r\n                        " + Utils.ObjectToStr(hotdr2["title"]) + "</p>\r\n                    ");
	if (id==int.Parse(Utils.ObjectToStr(hotdr2["id"]).ToString()))
	{
	...
	templateBuilder.Append("\r\n        <div class=\"wlbz_bt\">\r\n            <h3>\r\n                ");
	templateBuilder.Append(Utils.ObjectToStr(model_meal.title));
	templateBuilder.Append("</h3>\r\n            <a href=\"javascript:;\" onclick=\"meal_into_shopping(");
	templateBuilder.Append(Utils.ObjectToStr(id));
	templateBuilder.Append(")\">一键进购物车</a>\r\n        </div>\r\n        <div class=\"wlbz_nr\">\r\n            ");
	            string str_standard_good_price_ids=",";
	            

	int hotdr__loop__id=0;
	foreach(DataRow hotdr in dts.Rows)
	{
		hotdr__loop__id++;


	            model = art_bll.GetModel(int.Parse(Utils.ObjectToStr(hotdr["good_id"]).ToString())); if (str_standard_good_price_ids.IndexOf(","
	            + (Convert.ToInt32(hotdr["meal_id"]) + "-" + Convert.ToInt32(hotdr["good_id"]) +
	            "-" + Convert.ToDecimal(hotdr["standard_price_id"]) + "-" + Convert.ToDecimal(hotdr["unit_id"]))
	            + ",") > -1) { continue; } str_standard_good_price_ids += Convert.ToInt32(hotdr["meal_id"])
	            + "-" + Convert.ToInt32(hotdr["good_id"]) + "-" + Convert.ToDecimal(hotdr["standard_price_id"])
	            + "-" + Convert.ToDecimal(hotdr["unit_id"]) + ","; string money="0.00"; if(_userinfo!=null)
	            { money=Utils.ObjectToStr(hotdr["standard_group_price"]).ToString(); if(Utils.ObjectToStr(hotdr["standard_price_id"]).ToString()!="0"){money=Utils.ObjectToStr(hotdr["standard_price"]).ToString();}
	            }else{ money=Utils.ObjectToStr(hotdr["sell_price"]).ToString();}
	            

	templateBuilder.Append("\r\n            <dl>\r\n                <dt><a href=\"javascript:;\" onclick=\"open_detail('");
	templateBuilder.Append(Utils.ObjectToStr(model.id));
	templateBuilder.Append("')\">\r\n                    <img src=\"");
	templateBuilder.Append(Utils.ObjectToStr(model.img_url));
	templateBuilder.Append("\" width=\"227\" height=\"227\" border=\"0\" alt=\"\"></a></dt>\r\n                <dd>\r\n                    ");
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("</dd>\r\n                <dd>\r\n                    <strong>￥ ");
	templateBuilder.Append(Utils.ObjectToStr(money));
	templateBuilder.Append(" </strong><a href=\"");
	templateBuilder.Append(linkurl("goods_list",model.category_id));

	templateBuilder.Append("\">\r\n                        <span>更多");
	templateBuilder.Append(get_category_title(model.category_id,"").ToString());

	templateBuilder.Append("</span></a><div class=\"clear\">\r\n                        </div>\r\n                </dd>\r\n            </dl>\r\n            ");
	}	//end for if
