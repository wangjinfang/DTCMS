...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <!--顶部 end-->\r\n    <!---内容区 开始---->\r\n    <div class=\"content\">\r\n        <div class=\"content_left\">\r\n            <!--内容区 左-->\r\n            ");
	            DTcms.BLL.meal meal_bll = new DTcms.BLL.meal();
	            

	DataTable dts = meal_bll.GetList(0,"","sort_id asc,add_time desc").Tables[0];

	templateBuilder.Append("\r\n\r\n            <div class=\"content_left_mk\">\r\n               \r\n                <div class=\"content_left_mkl\" style=\"background:url();\">\r\n                    <script type=\"text/javascript\" src=\"/plugins/advert/advert_js.ashx?id=1\"></");
	templateBuilder.Append("script>\r\n                    </div>\r\n                \r\n\r\n\r\n                ");
	int hotdr_2__loop__id=0;
	foreach(DataRow hotdr_2 in dts.Rows)
	{
		hotdr_2__loop__id++;


	if (hotdr_2__loop__id==1)
	{

	templateBuilder.Append("\r\n                <div class=\"content_left_mkr\">\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_2["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_2["index_url"]) + "\" width=\"196\" height=\"154\" /></a></div>\r\n                ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n            </div>\r\n            <div class=\"content_left_mk\">\r\n                ");
	int hotdr_3__loop__id=0;
	foreach(DataRow hotdr_3 in dts.Rows)
	{
		hotdr_3__loop__id++;


	if (hotdr_3__loop__id==3)
	{

	templateBuilder.Append("\r\n                <div class=\"content_left_mkr1\">\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_3["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_3["index_url"]) + "\" width=\"196\" height=\"154\" /></a></div>\r\n                ");
	}	//end for if

	}	//end for if

	int hotdr_4__loop__id=0;
	foreach(DataRow hotdr_4 in dts.Rows)
	{
		hotdr_4__loop__id++;


	if (hotdr_4__loop__id==4)
	{

	templateBuilder.Append("\r\n                <div class=\"content_left_mkl1\">\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_4["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_4["index_url"]) + "\" width=\"288\" height=\"154\" /></a></div>\r\n                ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n            </div>\r\n            <div class=\"content_left_mk\">\r\n                ");
	int hotdr_5__loop__id=0;
	foreach(DataRow hotdr_5 in dts.Rows)
	{
		hotdr_5__loop__id++;


	if (hotdr_5__loop__id==5)
	{

	templateBuilder.Append("\r\n                <div class=\"content_left_mkl2\">\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_5["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_5["index_url"]) + "\" width=\"326\" height=\"154\" /></a></div>\r\n                ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n                <div class=\"content_left_mkr2\">\r\n                    <script type=\"text/javascript\" src=\"/plugins/advert/advert_js.ashx?id=3\"></");
	templateBuilder.Append("script>\r\n                    </div>\r\n            </div>\r\n            <div class=\"content_left_dbmk\">\r\n                ");
	int hotdr_6__loop__id=0;
	foreach(DataRow hotdr_6 in dts.Rows)
	{
		hotdr_6__loop__id++;


	if (hotdr_6__loop__id==7)
	{

	templateBuilder.Append("\r\n                <div class=\"content_left_jyxt\" style=\"background:url(" + Utils.ObjectToStr(hotdr_6["index_url"]) + ");\">\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_6["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_6["index_url"]) + "\" width=\"156\" height=\"316\" /></a></div>\r\n                ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n                <div class=\"content_left_tpggw3\">\r\n                    <script type=\"text/javascript\" src=\"/plugins/advert/advert_js.ashx?id=5\"></");
	templateBuilder.Append("script>\r\n                    </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"content_right\">\r\n            <!--内容区 右-->\r\n            <div class=\"content_right_smk\">\r\n                <div class=\"content_right_smk_left\">\r\n                    ");
	int hotdr_7__loop__id=0;
	foreach(DataRow hotdr_7 in dts.Rows)
	{
		hotdr_7__loop__id++;


	if (hotdr_7__loop__id==6)
	{

	templateBuilder.Append("\r\n                    <div class=\"content_right_smk_left_xyg\">\r\n                        <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_7["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_7["index_url"]) + "\" width=\"158\" height=\"320\" /></a></div>\r\n                    ");
	}	//end for if

	if (hotdr_7__loop__id==2)
	{

	templateBuilder.Append("\r\n                    <div class=\"content_right_smk_left_das\">\r\n                        <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_7["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_7["index_url"]) + "\" width=\"158\" height=\"154\" /></a></div>\r\n                    ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n                </div>\r\n                <div class=\"content_right_smk_right\">\r\n                    <div class=\"content_right_smk_right_tpggw1\">\r\n                        <script type=\"text/javascript\" src=\"/plugins/advert/advert_js.ashx?id=2\"></");
	templateBuilder.Append("script>\r\n                        </div>\r\n                    <div class=\"content_right_smk_right_tpggw2\">\r\n                        <script type=\"text/javascript\" src=\"/plugins/advert/advert_js.ashx?id=4\"></");
	templateBuilder.Append("script>\r\n                        </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"content_right_xmk\">\r\n                <div class=\"content_right_xmk_left\">\r\n                    ");
	int hotdr_8__loop__id=0;
	foreach(DataRow hotdr_8 in dts.Rows)
	{
		hotdr_8__loop__id++;


	if (hotdr_8__loop__id==8)
	{

	templateBuilder.Append("\r\n                    <div class=\"content_right_xmk_left_yhxt\">\r\n                        <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_8["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_8["index_url"]) + "\" width=\"322\" height=\"150\" /></a></div>\r\n                    ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n                    <div class=\"content_right_xmk_left_bottom\">\r\n                        ");
	int hotdr_9__loop__id=0;
	foreach(DataRow hotdr_9 in dts.Rows)
	{
		hotdr_9__loop__id++;


	if (hotdr_9__loop__id==9)
	{

	templateBuilder.Append("\r\n                        <div class=\"content_right_xmk_left_gc\">\r\n                            <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_9["id"])));

	templateBuilder.Append("\" ><img src=\"" + Utils.ObjectToStr(hotdr_9["index_url"]) + "\" width=\"156\" height=\"154\" /></a></div>\r\n                        ");
	}	//end for if

	if (hotdr_9__loop__id==10)
	{

	templateBuilder.Append("\r\n                        <div class=\"content_right_xmk_left_zfcg\" >\r\n                            <a href=\"");
	templateBuilder.Append(linkurl("meal_show",Utils.ObjectToStr(hotdr_9["id"])));

	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(hotdr_9["index_url"]) + "\" width=\"155\" height=\"154\" /></a></div>\r\n                        ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n                    </div>\r\n                </div>\r\n                <div class=\"content_right_xmk_right\">\r\n                    <script type=\"text/javascript\" src=\"/plugins/advert/advert_js.ashx?id=6\"></");
	templateBuilder.Append("script>\r\n                    </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <!---内容区 结束---->\r\n    <!--底部 start-->\r\n  <!--Footer-->\r\n    ");
	...
	templateBuilder.Append("\r\n    <!--/Footer-->\r\n    <!--底部 end-->\r\n    <!--悬浮框 start-->\r\n    <div class=\"suspension \" id=\"s_customer\">\r\n        <a href=\"#\">联系客服</a>\r\n    </div>\r\n    <div class=\"suspension \" id=\"s_search\" style=\"top: 425px;display:none;\">\r\n        <a href=\"javascript:;\" onclick=\"open_search()\">商品搜索</a>\r\n    </div>\r\n    <!--悬浮框 end-->\r\n    <!-------------------公共部分------------------------------------------------->\r\n    <!--覆盖页 start-->\r\n    <div class=\"black_overlay\">\r\n    </div>\r\n    <!--覆盖页 end-->\r\n  \r\n</body>\r\n</html>\r\n");
