...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <!--顶部 end-->\r\n    <!--合作企业开始-->\r\n    <div class=\"hezuoqy\">\r\n        <!--合作名企头部 开始-->\r\n        <div class=\"hezuoqytop\">\r\n            <p>\r\n                <img src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/hezuoqytop.jpg\" width=\"235px\" height=\"18px\" alt=\"合作名企\"></p>\r\n        </div>\r\n        <!--合作名企头部 结束-->\r\n        <!--合作名企小导航条 开始-->\r\n        <div class=\"hezuoqynav\">\r\n            <ul>\r\n                ");
	int i = 0;

	foreach(DataRow categorydr in category_dt.Rows)
	{

	 i = i+1;

	templateBuilder.Append("\r\n                <li ");
	if (categorydr["id"].ToString()==categoryid.ToString())
	{

	templateBuilder.Append("class=\"hezuoqynavli\"\r\n                    ");
	}	//end for if
	...
	templateBuilder.Append(linkurl("hezuoqy",Utils.ObjectToStr(categorydr["id"])));

	templateBuilder.Append("\">\r\n                        " + Utils.ObjectToStr(categorydr["title"]) + "</a></li>\r\n                ");
	}	//end for if

	templateBuilder.Append("\r\n            </ul>\r\n        </div>\r\n        <!--合作名企小导航条 开始-->\r\n        <div class=\"hezibig\">\r\n            <div class=\"hezibox\" style=\"display: block;\">\r\n                <div class=\"chainone\">\r\n                    <div class=\"chainonel hmleft\">\r\n                        <ul>\r\n                            <li>\r\n                                <img src=\"");
	templateBuilder.Append(Utils.ObjectToStr(categorymodel.img_url));
	templateBuilder.Append("\" width=\"198px\" height=\"326px\" alt=\"");
	templateBuilder.Append(Utils.ObjectToStr(categorymodel.title));
	templateBuilder.Append("\">\r\n                                <div class=\"chainoneltxtbox\">\r\n                                    <h1>\r\n                                        ");
	templateBuilder.Append(Utils.ObjectToStr(categorymodel.title));
	templateBuilder.Append("</h1>\r\n                                    ");
	foreach(DataRow dr in hezuoqy_dt.Rows)
	{

	templateBuilder.Append("\r\n                                    <div class=\"chainoneltxt\" style=\"display: none;\" >\r\n                                        <i></i>\r\n                                        <p>\r\n                                            " + Utils.ObjectToStr(dr["intro"]) + "\r\n                                        </p>\r\n                                    </div>\r\n                                    ");
	}	//end for if

	templateBuilder.Append("\r\n                                </div>\r\n                            </li>\r\n                        </ul>\r\n                    </div>\r\n                    <div class=\"chainoner hmright\">\r\n                        <ul>\r\n                            ");
	foreach(DataRow dr in hezuoqy_dt.Rows)
	{

	templateBuilder.Append("\r\n                            <li><a href=\"" + Utils.ObjectToStr(dr["link"]) + "\">\r\n                                <img src=\"" + Utils.ObjectToStr(dr["log_img"]) + "\" width=\"132px\" height=\"80px\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\"></a><p class=\"yidong\">\r\n                                    " + Utils.ObjectToStr(dr["join_time"]) + " 入驻</p>\r\n                            </li>\r\n                            ");
	}	//end for if

	if (hezuoqy_dt.Rows.Count==25)
	{

	templateBuilder.Append("\r\n                            <li><a href=\"javascript:void(0);\">更多名企</a></li>\r\n                            ");
	}	//end for if

	templateBuilder.Append("\r\n                        </ul>\r\n                    </div>\r\n                </div>\r\n                ");
	if (next_categorymodel.id>0)
	{

	templateBuilder.Append("\r\n                <div class=\"chainone\">\r\n                    <div class=\"chainonel hmright\">\r\n                        <ul>\r\n                            <li>\r\n                                <img src=\"");
	templateBuilder.Append(Utils.ObjectToStr(next_categorymodel.img_url));
	templateBuilder.Append("\" width=\"198px\" height=\"326px\" alt=\"");
	templateBuilder.Append(Utils.ObjectToStr(next_categorymodel.title));
	templateBuilder.Append("\">\r\n                                <div class=\"chainoneltxtbox\">\r\n                                    <h1>\r\n                                        ");
	templateBuilder.Append(Utils.ObjectToStr(next_categorymodel.title));
	templateBuilder.Append("</h1>\r\n                                    ");
	foreach(DataRow dr in next_hezuoqy_dt.Rows)
	{

	templateBuilder.Append("\r\n                                    <div class=\"chainoneltxt\" style=\"display: none;\">\r\n                                        <i></i>\r\n                                        <p>\r\n                                            " + Utils.ObjectToStr(dr["intro"]) + "\r\n                                        </p>\r\n                                    </div>\r\n                                    ");
	}	//end for if

	templateBuilder.Append("\r\n                                </div>\r\n                            </li>\r\n                        </ul>\r\n                    </div>\r\n                    <div class=\"chainoner hmleft\">\r\n                        <ul>\r\n                            ");
	foreach(DataRow dr in next_hezuoqy_dt.Rows)
	{
	...
	if (next_hezuoqy_dt.Rows.Count==25)
	{
	...
	templateBuilder.Append("\r\n    <!--底部 end-->\r\n    <script type=\"text/javascript\">\r\n        $(\".chainoner ul li\").mouseleave(function () {\r\n//            $(\".yidong\", this).fadeOut(500);\r\n            //            $(\".chainoneltxt\").eq($(\".chainoner ul li\").index(this)).hide();\r\n            $(\".yidong\", this).fadeOut(500);\r\n            $(\".chainoneltxt\").eq($(\".chainoner ul li\").index(this)).hide();\r\n        }).mouseenter(function () {\r\n            //$(\".yidong\",this).slideToggle(\"normal\");\r\n//            $(\".yidong\", this).fadeIn(500);\r\n            //            $(\".chainoneltxt\").eq($(\".chainoner ul li\").index(this)).fadeIn(500);\r\n            //$(\".yidong\", this).show(500);\r\n            $(\".yidong\", this).fadeIn(500);\r\n            $(\".chainoneltxt\").eq($(\".chainoner ul li\").index(this)).show();\r\n        });\r\n\r\n    </");
	templateBuilder.Append("script>\r\n    <!--企业描述性文字上移特效 开始-->\r\n    <!--合作企业导航 开始-->\r\n    <script type=\"text/javascript\" src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/js/jquery-1.10.2.min.js\"></");
	templateBuilder.Append("script>\r\n    <script type=\"text/javascript\">\r\n        $(\".hezuoqynav ul li\").mouseover(function () {\r\n            $(this).addClass(\"hezuoqynavli\").siblings().removeClass(\"hezuoqynavli\");\r\n            var index = $(this).index(); //获取当前的序列号\r\n            $(\".hezibig .hezibox\").eq(index).show().siblings().hide();\r\n        });\r\n    </");
	templateBuilder.Append("script>\r\n    <!--合作企业导航 结束-->\r\n</body>\r\n</html>\r\n");
