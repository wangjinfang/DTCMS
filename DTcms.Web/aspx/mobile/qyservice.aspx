<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.UI.Page.qyservice" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/js/public.js\" type=\"text/javascript\"></");
	...
	templateBuilder.Append("\r\n    <!--顶部 end-->\r\n    <!--企业服务 开始-->\r\n    <div class=\"qyservice\">\r\n        <div class=\"qyservicel\">\r\n            <ul>\r\n                ");
	foreach(DataRow dr in category_dt.Rows)
	{

	templateBuilder.Append("\r\n                <li ");
	if (categoryid.ToString()==dr["id"].ToString())
	{
	...
	templateBuilder.Append(linkurl("qyservice",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\">\r\n                    " + Utils.ObjectToStr(dr["title"]) + "</a></li>\r\n                ");
	}	//end for if

	templateBuilder.Append("\r\n            </ul>\r\n        </div>\r\n        <div class=\"qyservicer\">\r\n            <div class=\"qyservicertop\">\r\n                ");
	if (qyservice_dt.Rows.Count>0)
	{

	templateBuilder.Append("\r\n                <div class=\"qyservicertopl\">\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("qyservicedetails",qyservice_dt.Rows[0]["id"]));

	templateBuilder.Append("\">\r\n                        <img src=\"");
	templateBuilder.Append(qyservice_dt.Rows[0]["img_url"].ToString());

	templateBuilder.Append("\" width=\"388px\" height=\"288px\" alt=\"");
	templateBuilder.Append(qyservice_dt.Rows[0]["title"].ToString());

	templateBuilder.Append("\"></a>\r\n                    <div class=\"qyservicertopltxt\">\r\n                        <i></i>\r\n                        <dl>\r\n                            <dt>\r\n                                <img src=\"");
	templateBuilder.Append(qyservice_dt.Rows[0]["log_img"].ToString());

	templateBuilder.Append("\" width=\"86px\" height=\"53px\" alt=\"");
	templateBuilder.Append(qyservice_dt.Rows[0]["title"].ToString());

	templateBuilder.Append("\"></dt>\r\n                            <dd>\r\n                                ");
	templateBuilder.Append(qyservice_dt.Rows[0]["intro"].ToString());

	templateBuilder.Append("\r\n                            </dd>\r\n                        </dl>\r\n                    </div>\r\n                </div>\r\n                ");
	}	//end for if

	if (qyservice_dt.Rows.Count>2)
	{

	templateBuilder.Append("\r\n                <div class=\"qyservicertopr\">\r\n                    <div class=\"servicerone\">\r\n                        <a href=\"");
	templateBuilder.Append(linkurl("qyservicedetails",qyservice_dt.Rows[1]["id"]));

	templateBuilder.Append("\">\r\n                            <img src=\"");
	templateBuilder.Append(qyservice_dt.Rows[1]["img_url"].ToString());

	templateBuilder.Append("\" width=\"386px\" height=\"143px\" alt=\"");
	templateBuilder.Append(qyservice_dt.Rows[1]["title"].ToString());

	templateBuilder.Append("\"></a></div>\r\n                    <div class=\"servicertwo\">\r\n                        <a href=\"");
	templateBuilder.Append(linkurl("qyservicedetails",qyservice_dt.Rows[2]["id"]));

	templateBuilder.Append("\">\r\n                            <img src=\"");
	templateBuilder.Append(qyservice_dt.Rows[2]["img_url"].ToString());

	templateBuilder.Append("\" width=\"386px\" height=\"143px\" alt=\"");
	templateBuilder.Append(qyservice_dt.Rows[2]["title"].ToString());

	templateBuilder.Append("\"></a></div>\r\n                </div>\r\n                ");
	}	//end for if

	templateBuilder.Append("\r\n            </div>\r\n            <div class=\"qyservicerbot\">\r\n                <ul>\r\n                    ");
	int num = 0;

	foreach(DataRow dr in qyservice_dt.Rows)
	{
	...
	templateBuilder.Append("class=\"nomar\" ");
	}	//end for if

	templateBuilder.Append(">\r\n                        <p>\r\n                            <img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" width=\"192px\" height=\"191px\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\"></p>\r\n                        <div class=\"qyservicerbottxt\">\r\n                            <i><a href=\"");
	templateBuilder.Append(linkurl("qyservicedetails",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\">\r\n                                <img src=\"" + Utils.ObjectToStr(dr["log_img"]) + "\" width=\"154px\" height=\"60px\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\"></a></i>\r\n                            <strong><a href=\"");
	templateBuilder.Append(linkurl("qyservicedetails",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\">" + Utils.ObjectToStr(dr["title"]) + "</a></strong>\r\n                            <p>\r\n                                &nbsp;</p>\r\n                            <span>" + Utils.ObjectToStr(dr["click"]) + "人捧场</span>\r\n                        </div>\r\n                    </li>\r\n                    ");
	}	//end for if
	...
	templateBuilder.Append("script>\r\n    <script type=\"text/javascript\">\r\n        $(\".qyservicel ul li\").click(function () {\r\n            $(this).addClass(\"on\").siblings().removeClass(\"on\");\r\n        });\r\n    </");
	templateBuilder.Append("script>\r\n    <!--办公服务左侧导航条 结束-->\r\n</body>\r\n</html>\r\n");
