<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.UI.Page.good_category_list" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("script>\r\n    <script src=\"");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/js/scroll.js\" type=\"text/javascript\"></");
	templateBuilder.Append("script>\r\n</head>\r\n<body>\r\n    <!--顶部 start-->\r\n    ");
	...
	templateBuilder.Append("\r\n    <!--顶部 end-->\r\n    <!--三步导购 开始-->\r\n    <div class=\"Guide\">\r\n        <div class=\"guidestep\">\r\n            <ul>\r\n                <li><a href=\"#\" class=\"done\" style=\"cursor: default;\"><i></i>选大类</a></li>\r\n                <li><span class=\"spandone\"></span></li>\r\n                <li><a href=\"#\" class=\"on\" style=\"cursor: default;\"><i>2</i>选小类</a></li>\r\n                <li><span></span></li>\r\n                <li><a href=\"#\" style=\"cursor: default;\"><i>3</i>选属性</a></li>\r\n                <div class=\"clear\">\r\n                </div>\r\n            </ul>\r\n        </div>\r\n        <div class=\"guidelistsnr\">\r\n            <div class=\"button_one\">\r\n                <ul id=\"one_ul\">\r\n                    ");
	...
	templateBuilder.Append("\r\n                    <li name=\"li_one\" ");
	if (category_id==Convert.ToInt32(cdr2_tit["id"]))
	{

	templateBuilder.Append("class=\"onehover\" ");
	}	//end for if

	templateBuilder.Append("><a\r\n                        href=\"#\">\r\n                        <img src=\"" + Utils.ObjectToStr(cdr2_tit["img_url"]) + "\" />" + Utils.ObjectToStr(cdr2_tit["title"]) + "</a>\r\n                        <div class=\"button_two\" ");
	if (category_id==Convert.ToInt32(cdr2_tit["id"]))
	{

	templateBuilder.Append(" style=\" display:block;\"");
	}	//end for if

	templateBuilder.Append(">\r\n                            <ul name=\"ul_two\">\r\n                                ");
	DataTable category_list_tit1 = get_category_child_list("goods", Convert.ToInt32(cdr2_tit["id"]));

	int cdr3_tit__loop__id=0;
	foreach(DataRow cdr3_tit in category_list_tit1.Rows)
	{
		cdr3_tit__loop__id++;


	templateBuilder.Append("\r\n                                <li ");
	if (category_id==Convert.ToInt32(cdr2_tit["id"]) && cdr3_tit__loop__id==1)
	{

	templateBuilder.Append("class=\"twohover\"");
	}	//end for if

	templateBuilder.Append(" name=\"two_li\"><a href=\"#\">\r\n                                    <img src=\"" + Utils.ObjectToStr(cdr3_tit["img_url"]) + "\" />" + Utils.ObjectToStr(cdr3_tit["title"]) + "</a>\r\n                                     <div name=\"div_three\" style=\"position: absolute;left: 96px; width:auto; min-height:710px; top: 0px;background: white;");
	if (category_id==Convert.ToInt32(cdr2_tit["id"]) && cdr3_tit__loop__id!=1)
	{
	...
	templateBuilder.Append("\">\r\n                                        <ul style=\"padding:0px;background: white;width:800px;margin-left: 40px;\">\r\n                                        ");
	DataTable category_list_tit2 = get_category_child_list("goods", Convert.ToInt32(cdr3_tit["id"]));

	int cdr4_tit__loop__id=0;
	foreach(DataRow cdr4_tit in category_list_tit2.Rows)
	{
		cdr4_tit__loop__id++;


	templateBuilder.Append("\r\n                                            <li style=\"float:left; text-align:center;margin-right: 34px;height: 117px; width:99px; margin-bottom:30px;\"><a href=\"");
	templateBuilder.Append(linkurl("goods_list",Utils.ObjectToStr(cdr4_tit["id"])));

	templateBuilder.Append("\" target=\"_blank\" style=\" height:20px; width:99px;\">\r\n                                            <img src=\"" + Utils.ObjectToStr(cdr4_tit["img_url"]) + "\" style=\" width:99px; height:97px;\"  border=\"0\" alt=\"\" >" + Utils.ObjectToStr(cdr4_tit["title"]) + "</a></li>\r\n                                        ");
	}	//end for if
	...
	templateBuilder.Append("\r\n    <!--/Footer-->\r\n    <!--左侧切换-->\r\n    <script type=\"text/javascript\">\r\n\r\n\r\n        $(\"[name=li_one]\").mouseover(function () {\r\n            //一级类别\r\n\r\n\r\n\r\n\r\n            $(this).siblings().removeClass(\"onehover\");\r\n            //$(this).addClass(\"good_category_on1\");\r\n            $(this).css(\"background\", \"url(");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/guide/second2_21.jpg) center right no-repeat\");\r\n            $(this).siblings().css(\"background\", \"none\");\r\n            $(this).find(\".button_two\").show();\r\n            $(this).siblings().find(\".button_two\").hide();\r\n        });\r\n\r\n\r\n        $(\"[name=two_li]\").mouseover(function () {\r\n            $(\"[name=two_li]\").removeClass(\"twohover\");\r\n            $(this).css(\"background\", \"url(");
	templateBuilder.Append("/templates/ql");
	templateBuilder.Append("/images/guide/second2_13.jpg) center right no-repeat\");\r\n            $(this).siblings().css(\"background\", \"none\");\r\n            $(\"[name=div_three]\").each(function () {\r\n                $(this).hide();\r\n            });\r\n            $(this).find(\"[name=div_three]\").show();\r\n        });\r\n    </");
	templateBuilder.Append("script>\r\n    <!--右侧切换-->\r\n</body>\r\n</html>\r\n");
