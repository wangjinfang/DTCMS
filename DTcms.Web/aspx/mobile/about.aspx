<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.UI.Page.about" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n<!--顶部 end--> \r\n<!--企业帮助页内容 start-->\r\n<div class=\"help_center\">\r\n  <div class=\"help_center_left\">\r\n    <ul >\r\n      <li><a href=\"#\">关于企力</a></li>\r\n      <li><a href=\"#\">帮助中心</a></li>\r\n    </ul>\r\n  </div>\r\n  <div class=\"help_center_right\"> \r\n    <!--关于企力 start-->\r\n    <div class=\"about\">\r\n      <div class=\"help_center_right_title\">关于企力 </div>\r\n     \r\n        ");
	templateBuilder.Append(Utils.ObjectToStr(model.content));
	templateBuilder.Append("\r\n      \r\n    </div>\r\n    <!--关于企力 end--> \r\n    <!--帮助中心 start-->\r\n    <div class=\"help\">\r\n      <div class=\"help_center_right_title\">帮助中心 </div>\r\n      <div class=\"help_content\">\r\n        <ul>\r\n        ");
	DataTable new_list1 = get_category_child_list("news",257);

	int cd_category__loop__id=0;
	foreach(DataRow cd_category in new_list1.Rows)
	{
		cd_category__loop__id++;


	templateBuilder.Append("\r\n          <li>\r\n            <dl> \r\n\r\n              <dt>" + Utils.ObjectToStr(cd_category["title"]) + "</dt>\r\n              ");
	DataTable goods_list = get_article_list("news",0, "category_id="+Convert.ToInt32(cd_category["id"]));

	templateBuilder.Append("<!--取得一个分页DataTable-->\r\n          ");
	foreach(DataRow dr in goods_list.Rows)
	{

	templateBuilder.Append("\r\n              <dd><a href=\"#\">" + Utils.ObjectToStr(dr["title"]) + "</a>\r\n              <div class=\"help_content_answear\">\r\n              " + Utils.ObjectToStr(dr["content"]) + "\r\n                       </div>\r\n                       </dd>\r\n            ");
	}	//end for if
