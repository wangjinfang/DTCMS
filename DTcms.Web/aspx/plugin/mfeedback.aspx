...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by DTcms Template Engine at 2014/3/20 15:25:24.
		本页面代码由DTcms模板引擎生成于 2014/3/20 15:25:24. 
	*/
	...
	DataTable list = new DTcms.Web.Plugin.Feedback.feedback().get_feedback_list(10, page, "", out totalcount);
	...
	templateBuilder.Append("</div>\r\n      <!--/分页页码-->\r\n      \r\n      <!--页面底部导航-->\r\n      <div class=\"copyright\">\r\n        <p><a href=\"#\">触屏版</a> | <a href=\"#\">电脑版</a> | <a href=\"javascript:;\" onclick=\"$.ui.scrollToTop('mainPanel')\">返回顶部</a></p>\r\n        <address>版权所有 动力启航软件工作室 版本号 V3.0</address></p>\r\n      </div>\r\n      <!--页面底部导航-->\r\n	</div>\r\n    <!--留言反馈-->\r\n    \r\n    <!--发表留言-->\r\n    <div id=\"addPanel\" class=\"panel\" data-footer=\"main_footer\">\r\n      <header>\r\n        <a onclick=\"history.back(-1);\" class=\"backButton\">返回</a>\r\n        <h1>发表留言</h1>\r\n        <a onclick=\"$.ui.toggleSideMenu()\" class=\"menuButton\"></a>\r\n      </header>\r\n      \r\n      <form id=\"feedback_form\" name=\"feedback_form\" url=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
