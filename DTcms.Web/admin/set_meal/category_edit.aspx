<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_edit.aspx.cs" Inherits="DTcms.Web.admin.set_meal.category_edit" ValidateRequest="false" %>
...
<script type="text/javascript">
    ...
    //别名
    function add_alias() {
        var str = "<span onclick=\"ck_alias(this)\">&nbsp;&nbsp;" + $("#txt_alias").val()
            + "<input type=\"checkbox\" name=\"ck_alias\" checked=\"checked\" value=\"" + $("#txt_alias").val() + "\" style=\"display:none;\" />&nbsp;&nbsp;</span>";
        $("#dd_alias").append(str);
        $("#txt_alias").val("");
    }

    function ck_alias(obj) {
        if ($(obj).hasClass("on")) {
            $(obj).removeClass("on");
        }
        else {
    ...
    function del_alias() {
        $("#dd_alias").find(".on").remove();
    }

    //属性
    function add_property() {
        var str = "<span onclick=\"ck_property(this)\">&nbsp;&nbsp;" + $("#txt_property").val()
            + "<input type=\"checkbox\" name=\"ck_property\" checked=\"checked\" value=\"" + $("#txt_property").val() + "\" style=\"display:none;\" />&nbsp;&nbsp;</span>";
        $("#dd_property").append(str);
        $("#txt_property").val("");
    }

    function ck_property(obj) {
        if ($(obj).hasClass("on")) {
            $(obj).removeClass("on");
        }
        else {
