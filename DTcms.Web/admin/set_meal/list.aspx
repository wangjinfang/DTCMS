<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.set_meal.list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td  align="center"> 
        <%#new DTcms.BLL.meal_category().GetTitle(Convert.ToInt32(Eval("category_id")))%>
    </td>
