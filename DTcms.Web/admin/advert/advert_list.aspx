<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advert_list.aspx.cs" Inherits="DTcms.Web.admin.advert.advert_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><a href="advert_edit.aspx?action=<%=DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
      ...
      <a href="advert_view.aspx?id=<%#Eval("id")%>">调用</a>&nbsp;
