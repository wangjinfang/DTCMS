    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>显示数量</dt>
                <dd>
                    <asp:TextBox ID="txtViewNum" runat="server" CssClass="input small" datatype="n" sucmsg=" " /></dd>
            </dl>
            <dl>
                <dt>价格</dt>
                <dd>
                    <asp:TextBox ID="txtPrice" runat="server" CssClass="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox>
                    元
                </dd>
            </dl>
            <dl>
                <dt>宽度</dt>
                <dd>
                    <asp:TextBox ID="txtViewWidth" runat="server" CssClass="input small" datatype="n" sucmsg=" " />
                    px</dd>
            </dl>
            <dl>
                <dt>高度</dt>
                <dd>
                    <asp:TextBox ID="txtViewHeight" runat="server" CssClass="input small" datatype="n" sucmsg=" " />
                    px</dd>
            </dl>
            <dl>
                <dt>链接目标</dt>
