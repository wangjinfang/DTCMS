    ...
    <div class="l-list">
      <ul class="icon-list">
        ...
        <%if (channel_name == "goods")
          {%>
        <li><asp:LinkButton ID="LinkButton2" runat="server" CssClass="add" 
                onclick="LinkButton2_Click" ><i></i><span>批量上架</span></asp:LinkButton></li>
         <li><asp:LinkButton ID="LinkButton1" runat="server" CssClass="del" 
                 onclick="LinkButton1_Click" ><i></i><span>批量下架</span></asp:LinkButton></li>
         <%} %>
      </ul>
      <div class="menu-list">
...
<ItemTemplate>
  <tr>
    ...
    <%if (channel_name == "goods")
      {%>
    <td align="center"><%#Eval("is_put").ToString()=="1"?"上架":"下架" %></td>
    <%} %>
