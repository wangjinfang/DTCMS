...
namespace DTcms.Web.admin.channel
{
    public partial class attribute_field_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("site_channel_field", DTEnums.ActionEnum.View.ToString()); //检查权限
        ...
        {
            ChkAdminLevel("site_channel_field", DTEnums.ActionEnum.Edit.ToString()); //检查权限
            BLL.article_attribute_field bll = new BLL.article_attribute_field();
        ...
        {
            ChkAdminLevel("site_channel_field", DTEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
