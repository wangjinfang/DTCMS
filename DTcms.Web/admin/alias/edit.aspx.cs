...
namespace DTcms.Web.admin.alias
{
    public partial class edit : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_action) && _action == DTEnums.ActionEnum.Edit.ToString())
            {
                ...
                if (!new BLL.alias().Exists(this.id))
                {
        ...
        private void ShowInfo(int _id)
        {
            ...
            Model.alias model = bll.GetModel(_id);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改别名成功！", "list.aspx", "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加别名成功！", "list.aspx", "Success");
            }
        }
    }
}