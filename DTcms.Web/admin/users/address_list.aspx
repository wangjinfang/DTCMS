<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="address_list.aspx.cs" Inherits="DTcms.Web.admin.users.address_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td  align="center"> 
        <%#Convert.ToInt32(Eval("is_default"))==1?"否":"默认"%> 
    </td>
    <td align="center">
      <%#Eval("province")%>
    </td>
    <td align="center"><%#Eval("city")%></td>
    <td align="center"><%#Eval("distract") %></td>
