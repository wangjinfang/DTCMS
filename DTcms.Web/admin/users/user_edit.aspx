...
<div class="tab-content">
  ...
  <dl>
    <dt>用户类型</dt>
    <dd><asp:RadioButtonList ID="rb_user_type" runat="server" RepeatDirection="Horizontal">
    <asp:ListItem Text="个人用户" Value="1" Selected="True"></asp:ListItem>
    <asp:ListItem Text="企业用户" Value="2"></asp:ListItem>
    </asp:RadioButtonList> <span class="Validform_checktip">*</span></dd>
  </dl> 
  <dl>
    <dt>登录密码</dt>
  ...
  <dl>
    ...
    <asp:DropDownList ID="ddl_city" runat="server" AutoPostBack="True" 
            onselectedindexchanged="ddl_city_SelectedIndexChanged"><asp:ListItem Text="请选择市..." Value="0"></asp:ListItem></asp:DropDownList>
    <asp:DropDownList ID="ddl_district" runat="server"><asp:ListItem Text="请选择区/县..." Value="0"></asp:ListItem></asp:DropDownList>
