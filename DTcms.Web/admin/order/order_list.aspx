...
<script type="text/javascript">
   function export_excel(page,pagesize,where,order){
       $.ajax({
           type: "POST",
           url: "/tools/export_ajax.ashx?page=" + page + "&pagesize=" + pagesize + "&where=" + where + "&order=" + order,
           dataType: "text",
           timeout: 20000, 
  ...
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        ...
        <li><a class="save" href="/tools/export_ajax.ashx?page=<%=page%>&pagesize=<%=pageSize%>&where=<%=ajaxwhere%>&order=status asc,add_time desc,id desc" id="a_export"  ><i></i><span>导出</span></a></li>
      </ul>
      <div class="menu-list">
...
<ItemTemplate>
  <tr>
    <td align="center"><%--Enabled='<%#bool.Parse((Convert.ToInt32(Eval("status")) > 3 ).ToString())%>'--%>
