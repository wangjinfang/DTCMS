...
{
    public partial class job : Web.UI.BasePage
    {
        ...
        /// <param name="strwhere">查询条件</param>
        /// <returns>DataTable</returns>
        public DataSet get_job_list(int top, string strwhere, string filedOrder)
        {
            return new BLL.job().GetList(top, strwhere, filedOrder);
        }
        ...
        {
            return new BLL.job().GetPageList(pageSize, currentPage, strWhere, filedOrder);
        }
    }
}
