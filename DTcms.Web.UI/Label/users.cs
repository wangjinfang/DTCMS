...
namespace DTcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected DataTable get_user_branch_list(int pageSize, int pageIndex, string strWhere, string filedOrder, out int totalcount)
        {
            BLL.users bll = new BLL.users();
            return bll.GetBranchList(pageSize, pageIndex, strWhere, filedOrder, out totalcount).Tables[0];
        }
