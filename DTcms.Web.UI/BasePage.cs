...
namespace DTcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        {
            return Utils.OutPageList(pagesize, pageindex, totalcount, linkurl, 10);
        }
        /// <summary>
        /// 返回分页字符串
        /// </summary>
        ...
        public string get_page_links(int pagesize, int pageindex, int totalcount, string linkurl)
        {
            return Utils.OutPageList(pagesize, pageindex, totalcount, linkurl, 10);
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public string get_province_title(int id)
        {
            BLL.province bll = new BLL.province();
            Model.province model = bll.GetModel(id);
            if (model != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable get_city(string strwhere)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable get_district(string strwhere)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public string get_district_title(int id)
        {
            BLL.district bll = new BLL.district();
            Model.district model = bll.GetModel(id);
            if (model != null)
            {
